...
// created method for getting user current location
  ...
  Future AddNearbyMentalHealthCenter(double longitude, double latitude) async {
    String result =
        'https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=$latitude,$longitude&radius=1500&type=hospital&key=AIzaSyCJzMv3rEbVpBkU3ZP-V0ZjYHG5oNa7Qj0';
